...
import 'package:inspirze_onboarding_app/ui/admin/views/questionnaire/add_questionnaire.dart';
...
class _QuestionnaireViewState extends State<QuestionnaireView> {
  ...
  Widget build(BuildContext context) {
    ListTile makeListTile(Lesson lesson) => ListTile(
      ...
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => const AddQuestionnaire()));
      },
    );
