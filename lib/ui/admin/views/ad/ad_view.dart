...
import 'package:inspirze_onboarding_app/core/models/ad.dart';
import 'package:inspirze_onboarding_app/core/services/ad_service.dart';
...
class _AdViewState extends State<AdView> {
  ...
  late Future<List<Ad>> futureAd;

  @override
  void initState() {
    futureAd = AdService().getAds();
    lessons = getLessons();
    super.initState();
  }
